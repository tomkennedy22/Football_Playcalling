                        ...
                        if table is not None:
                            ...
                            for Play in data:
                                ...
                                if len(BallSpotSplit) == 2:
                                    ...
                                    Play['Lead'] = -1 * Play['Lead'] if TeamLookup[Team] == Play['OffenseTeam'] else Play['Lead']
